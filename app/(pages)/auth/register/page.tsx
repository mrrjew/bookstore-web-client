...
export default function Page() {
  ...
  return (
    <div className="flex items-center h-screen w-full">
      <div className="w-4/6 h-screen font-libre max-md:hidden relative">
     ...
     <div className="flex bg-white rounded-md w-3/5 py-8 px-8 flex-col p-10 text-left items-center justify-center ">
