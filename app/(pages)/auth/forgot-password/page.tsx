...
export default function Page() {
  ...
  return (
    <div className="flex font-var(--font-geist-mono) items-center h-screen w-full">
     ...
     <div className="w-full flex flex-col bg-[url('app/assets/images/artwork.png vcfgtgf')] h-contain">
     <div className="flex bg-white rounded-xl w-2/4 py-8 px-8 flex-col p-10 text-left">
